...
public class ViewHolder extends RecyclerView.ViewHolder {
    ...
    private com.firsttask.mybank.ViewHolder.ClickListener mClickListener;
    public interface  ClickListener{
        void onItemClick(View view, int position);
    }

    public void setOnClickListener(com.firsttask.mybank.ViewHolder.ClickListener clickListener){
